...
void loop(){
  ...
  eyesGreen(100);  //both eyes purple at 100 brightness
  delay(2000);      //wait 3 seconds
  rightRed(200);       //turn off right eye (so he “winks”)
  delay(500);       //wait 1/4 second 
  eyesPink(100);    //Change to pink eyes
  delay(1000);      //wait 1 second
  leftCyan(200);    //wink with left eye
  delay(500);
